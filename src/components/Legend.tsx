...
export const Legend: React.FC<LegendProps> = ({ data }) => {
  ...
  return (
    <motion.div
      drag
      dragMomentum={false}
      className="absolute top-2 md:top-20 right-2 md:right-8 bg-white/80 backdrop-blur-md p-3 md:p-4 rounded-xl border border-gray-200 cursor-move z-10 min-w-[100px] md:min-w-[120px]"
